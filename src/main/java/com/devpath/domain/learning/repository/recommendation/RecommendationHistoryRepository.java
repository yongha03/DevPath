...
public interface RecommendationHistoryRepository
  ...
  List<RecommendationHistory> findAllByUserIdAndRoadmapNodeNodeIdOrderByCreatedAtDesc(
      Long userId, Long nodeId);

  List<RecommendationHistory> findAllByUserIdAndRecommendationIdOrderByCreatedAtDesc(
