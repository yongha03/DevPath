...
/**
 * 노드 필수 태그 매핑 엔티티 - 특정 노드를 클리어하기 위해 필요한 필수 기술 태그들을 매핑 - 학습자가 해당 노드를 스킵하려면 이 테이블에 정의된 모든 태그를 보유해야 함
 */
@Entity
@Table(
    ...
    indexes = {@Index(name = "idx_node_required_tags_node_id", columnList = "node_id")})
@Getter
