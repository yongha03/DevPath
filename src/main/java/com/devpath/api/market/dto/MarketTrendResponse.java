...
public class MarketTrendResponse {
  ...
  public record AdminReport(
      ...
      @Schema(description = "상위 인기 기술 스택") List<SkillStackTrend> topSkills,
      @Schema(description = "상위 직무 트렌드") List<JobTrend> topJobRoles,
      @Schema(description = "지역별/경력별 지표") List<Indicator> indicators,
