...
public class ProjectService {
    ...
    @Transactional
    public ProjectResponse updateIntro(Long projectId, Long requesterId, UpdateProjectIntroRequest request) {
        Project project = getProjectEntity(projectId);
    ...
    @Transactional
    public ProjectResponse updateVisibility(Long projectId, Long requesterId, UpdateProjectVisibilityRequest request) {
        Project project = getProjectEntity(projectId);
        validateOwner(project, requesterId);
    ...
    @Transactional
    public ProjectResponse updateRecruitingStatus(Long projectId, Long requesterId, UpdateRecruitingStatusRequest request) {
        Project project = getProjectEntity(projectId);
        validateOwner(project, requesterId);
