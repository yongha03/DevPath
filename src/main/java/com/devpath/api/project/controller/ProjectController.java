...
public class ProjectController {
    ...
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "수정 성공"),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "403", description = "오너 권한 없음",
                    content = @Content(schema = @Schema(implementation = SwaggerErrorResponse.class))),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "404", description = "프로젝트를 찾을 수 없음",
                    content = @Content(schema = @Schema(implementation = SwaggerErrorResponse.class)))
    })
    public ApiResponse<ProjectResponse> updateIntro(
        ...
        return ApiResponse.ok(projectService.updateIntro(projectId, requireUserId(requesterId), request));
    }
    ...
    public ApiResponse<ProjectResponse> updateVisibility(
        ...
        return ApiResponse.ok(projectService.updateVisibility(projectId, requireUserId(requesterId), request));
    }
    ...
    public ApiResponse<ProjectResponse> updateRecruitingStatus(
        ...
        return ApiResponse.ok(projectService.updateRecruitingStatus(projectId, requireUserId(requesterId), request));
    }
}