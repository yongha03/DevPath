...
public class ResumeClinicResponse {
  ...
  public record StrengthSummary(
      ...
      @Schema(description = "핵심 기술 스택", example = "[\"Java\", \"Spring Boot\", \"JPA\"]")
          List<String> skills,
      @Schema(description = "학습 이력 기반 강점 요약", example = "Spring Boot와 JPA 학습 이력이 탄탄합니다.") String learningStrengthSummary,
      @Schema(description = "프로젝트 이력 기반 강점 요약", example = "프로젝트에서 REST API 설계와 인증 기능을 구현했습니다.") String projectStrengthSummary,
      @Schema(description = "Proof Card 기반 강점 요약", example = "PR 리뷰 통과 이력으로 구현 역량을 증명했습니다.") String proofCardStrengthSummary,
      @Schema(description = "종합 강점 요약", example = "백엔드 API 설계와 데이터 모델링에 강점이 있습니다.") String overallSummary,
  ...
  public record HighlightPoints(
      @Schema(description = "목표 직무", example = "Backend Developer") String targetRole,
      @Schema(description = "강조 포인트 목록", example = "[\"REST API 설계\", \"JPA 데이터 모델링\"]") List<String> highlightPoints,
      @Schema(description = "이력서 bullet 문구 목록", example = "[\"Spring Boot 기반 인증 API를 구현했습니다.\"]") List<String> bulletPoints,
  ...
  public record PortfolioPhrases(
      ...
      @Schema(description = "포트폴리오 소개 문구", example = "Spring Boot 기반 API 설계와 JPA 데이터 모델링에 강점이 있습니다.") String introduction,
      @Schema(description = "프로젝트 설명 문구", example = "[\"DevPath에서 멘토링 API와 PR 리뷰 흐름을 구현했습니다.\"]") List<String> projectPhrases,
      @Schema(description = "Proof Card 설명 문구", example = "[\"Spring Boot 미션 통과로 구현 역량을 검증했습니다.\"]") List<String> proofCardPhrases,
      @Schema(description = "마무리 문구", example = "[\"사용자 성장과 채용 연결에 기여하는 백엔드 개발자가 되겠습니다.\"]") List<String> closingPhrases) {}
  ...
  public record GeneratedContent(
      ...
      @Schema(description = "생성 문구", example = "Spring Boot 기반 API 설계 경험을 갖춘 백엔드 개발자입니다.") String content,
      @Schema(description = "관련 키워드", example = "[\"Spring Boot\", \"JPA\"]") List<String> keywords) {
