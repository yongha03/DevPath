...
public class NotificationEventService {
    ...
    public NotificationResponse notifyApplicationApproved(Long receiverId, String title) {
        return notify(
                receiverId,
                LearnerNotificationType.APPLICATION_APPROVED,
                "신청이 승인되었습니다: " + title
        );
    }
    ...
    public NotificationResponse notifyApplicationRejected(Long receiverId, String title) {
        return notify(
                receiverId,
                LearnerNotificationType.APPLICATION_REJECTED,
                "신청이 거절되었습니다: " + title
        );
    }

    private NotificationResponse notify(Long receiverId, LearnerNotificationType type, String message) {
