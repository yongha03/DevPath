...
public class ShowcaseController {
    ...
    public ApiResponse<List<ShowcaseSummaryResponse>> getShowcases(
            ...
            @Parameter(description = "정렬 방식 (LATEST/POPULAR)") @RequestParam(required = false, defaultValue = "LATEST") ShowcaseSort sort
    ) {
    ...
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "조회 성공"),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "404", description = "쇼케이스 없음",
                    content = @Content(schema = @Schema(implementation = SwaggerErrorResponse.class)))
    })
    ...
    public ApiResponse<ShowcaseResponse> updateShowcase(
        ...
        return ApiResponse.ok(showcaseService.updateShowcase(showcaseId, requireUserId(userId), request));
    }
    ...
    @ApiResponses({
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "409", description = "좋아요 안 한 상태",
                    content = @Content(schema = @Schema(implementation = SwaggerErrorResponse.class)))
    })
    ...
    public ApiResponse<ShowcaseCommentResponse> addComment(
        ...
        return ApiResponse.ok(showcaseSocialService.addComment(showcaseId, requireUserId(userId), request));
    }
