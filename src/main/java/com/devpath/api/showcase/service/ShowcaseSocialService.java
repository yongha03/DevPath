...
public class ShowcaseSocialService {
    ...
    public void addLike(Long showcaseId, Long userId) {
        ...
        showcaseLikeRepository.save(ShowcaseLike.builder()
    ...
    @Transactional
    public ShowcaseCommentResponse addComment(Long showcaseId, Long userId,
            CreateShowcaseCommentRequest request) {
        showcaseService.getShowcaseEntity(showcaseId);
        ShowcaseComment comment = ShowcaseComment.builder()
                .showcaseId(showcaseId)
                .userId(userId)
    ...
    public void deleteComment(Long commentId, Long userId) {
        ShowcaseComment comment = showcaseCommentRepository.findByIdAndIsDeletedFalse(commentId)
