...
public class PortfolioController {
    ...
    public ApiResponse<PortfolioResponse> updatePortfolio(
        ...
        return ApiResponse.ok(portfolioService.updatePortfolio(portfolioId, requireUserId(userId), request));
    }
    ...
    public ApiResponse<PortfolioItemResponse> addProofCard(
        ...
        return ApiResponse.ok(portfolioService.addItem(portfolioId, requireUserId(userId),
                PortfolioItemType.PROOF_CARD, request));
    }
    ...
    public ApiResponse<PortfolioItemResponse> addAssignment(
        ...
        return ApiResponse.ok(portfolioService.addItem(portfolioId, requireUserId(userId),
                PortfolioItemType.ASSIGNMENT, request));
    }
    ...
    public ApiResponse<PortfolioItemResponse> addProject(
        ...
        return ApiResponse.ok(portfolioService.addItem(portfolioId, requireUserId(userId),
                PortfolioItemType.PROJECT, request));
    }
    ...
    public ApiResponse<PortfolioGithubCommitResponse> addGithubCommit(
        ...
        return ApiResponse.ok(portfolioService.addGithubCommit(portfolioId, requireUserId(userId), request));
    }
    ...
    public ApiResponse<List<Object>> getDownloadHistories(
        ...
        return ApiResponse.ok(portfolioPdfService.getDownloadHistories(portfolioId, requireUserId(userId)));
    }
}