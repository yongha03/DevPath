...
@Tag(name = "관리자 - 공지사항", description = "관리자 공지사항 API")
@RestController
...
public class AdminNoticeController {
  ...
  public ApiResponse<NoticeResponse> updateNotice(
    ...
    return ApiResponse.success(
        "공지가 수정되었습니다.", adminNoticeService.updateNotice(noticeId, userId, request));
  }

  @Operation(summary = "공지 삭제", description = "공지를 soft delete 처리합니다.")
  @DeleteMapping("/{noticeId}")
  public ApiResponse<Void> deleteNotice(
      @PathVariable Long noticeId, @Parameter(hidden = true) @AuthenticationPrincipal Long userId) {
