...
public class MentoringPostResponse {
  ...
  public record Summary(
      ...
      @Schema(description = "멘토링 분야", example = "Backend") String category,
      @Schema(description = "멘토링 유형", example = "study") String mentoringType,
      @Schema(description = "진행 기간 주차", example = "4") Integer durationWeeks,
    ...
    public static Summary from(MentoringPost post) {
      return new Summary(
          ...
          post.getCategory(),
          post.getMentoringType(),
          post.getDurationWeeks(),
          post.getCurriculum(),
