...
public class MilestoneController {
    ...
    public ApiResponse<MilestoneResponse> createMilestone(
        ...
        return ApiResponse.ok(milestoneService.createMilestone(workspaceId, requireUserId(userId), request));
    }
    ...
    @ApiResponses({
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "403", description = "멤버 아님",
                    content = @Content(schema = @Schema(implementation = SwaggerErrorResponse.class))),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "404", description = "마일스톤 없음",
                    content = @Content(schema = @Schema(implementation = SwaggerErrorResponse.class)))
    })
    public ApiResponse<MilestoneResponse> updateMilestone(
        ...
        return ApiResponse.ok(milestoneService.updateMilestone(milestoneId, requireUserId(userId), request));
    }
