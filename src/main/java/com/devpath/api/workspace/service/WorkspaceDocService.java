...
public class WorkspaceDocService {
    ...
    @Transactional
    public WorkspaceDocResponse upsertDoc(Long workspaceId, Long userId,
            WorkspaceDocType docType, UpdateWorkspaceDocRequest request) {
        validateWorkspaceExists(workspaceId);
        validateMember(workspaceId, userId);

        Optional<WorkspaceDoc> existing = workspaceDocRepository
    ...
    public WorkspaceDocResponse getDoc(Long workspaceId, Long userId, WorkspaceDocType docType) {
        ...
        return workspaceDocRepository.findByWorkspaceIdAndDocType(workspaceId, docType)
                .map(WorkspaceDocResponse::from)
                .orElseThrow(() -> new CustomException(ErrorCode.DOC_NOT_FOUND));
    }

    @Transactional
    public MeetingNoteResponse createMeetingNote(Long workspaceId, Long userId,
