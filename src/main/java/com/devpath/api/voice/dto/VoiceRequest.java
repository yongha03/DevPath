...
public class VoiceRequest {
  ...
  @Schema(name = "VoiceChatMessageCreateRequest", description = "Voice meeting chat message create request")
  ...
  @Schema(name = "VoiceMeetingMinutesUpdateRequest", description = "Voice meeting minutes update request")
  public record MinutesUpdate(
      ...
      @Schema(description = "Meeting summary")
          @Size(max = 10000, message = "요약은 10000자 이하여야 합니다.")
          String summary) {}

  @Schema(name = "VoiceMeetingMinutesTranscriptAppendRequest", description = "Append one transcript line")
  ...
  @Schema(name = "VoiceMeetingMinutesActionItemsCreateRequest", description = "Create Kanban tasks from AI minutes action items")
  ...
  @Schema(name = "VoiceMeetingMinutesActionItemCreateRequest", description = "AI minutes action item to create as a Kanban task")
