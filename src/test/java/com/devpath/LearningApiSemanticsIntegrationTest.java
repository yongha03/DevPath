...
class LearningApiSemanticsIntegrationTest {
  ...
  void getProgressAndPlayerConfigDoNotCreateRows() throws Exception {
    ...
    JsonNode progress =
        getAsLearner("/api/learning/sessions/{lessonId}/progress", lessonIdWithoutProgress);
    JsonNode playerConfig =
        getAsLearner("/api/learning/player/{lessonId}/config", lessonIdWithoutProgress);
